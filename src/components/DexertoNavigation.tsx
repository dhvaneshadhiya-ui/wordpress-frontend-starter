    ...
    <>
                  ...
                  >
                    ...
                    {activeMenu === item.title && item.popular.length > 0 && (
                      <div className="absolute left-0 top-full pt-2 z-50">
                        <div className="animate-dropdown-in bg-card border border-border rounded-lg shadow-xl p-6 min-w-[600px]">
      ...
      {mobileMenuOpen && (
        <>
          ...
          />
          <div className="fixed top-14 sm:top-16 right-0 bottom-0 z-50 w-full max-w-sm bg-card border-l border-border lg:hidden animate-slide-in-right overflow-y-auto">
            <div className="p-4">
